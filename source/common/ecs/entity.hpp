...
namespace our {
    ...
    class Entity {
        ...
        friend World;       // The world is a friend since it is the only class that is allowed to
                            // instantiate an entity
        Entity() = default; // The entity constructor is private since only the world is allowed to
                            // instantiate an entity
      public:
        std::string
            name; // The name of the entity. It could be useful to refer to an entity by its name
        Entity *parent; // The parent of the entity. The transform of the entity is relative to its
                        // parent. If parent is null, the entity is a root entity (has no parent).
        ...
        glm::mat4 getLocalToWorldMatrix() const; // Computes and returns the transformation from the
                                                 // entities local space to the world space
        ...
        template <typename T> T *addComponent() {
            ...
            // TODO: (Req 8) Create an component of type T, set its "owner" to be this entity, then
        ...
        template <typename T> T *getComponent() {
            // TODO: (Req 8) Go through the components list and find the first component that can be
            // dynamically cast to "T*".
